...
describe("Smoke testy: Administracja", () => {
    ...
    // it("Smoke: Katalog produktów - dodawanie usługi", () => {
    ...
    //     cy.get('.clr-form-control > .clr-control-container > .clr-input-wrapper > #code').type('_TEST_')
    ...
    //     cy.get('#NAMES').type('__USLUGA__TEST__ ąęółżźć');
    //     cy.get('.btn').contains('Filtruj').click().wait(1000);
    //     cy.get('.datagrid').should('contain.text','__USLUGA__TEST__ ąęółżźć');
    // });

    // it("Smoke: Katalog produktów - usuwanie usługi", () => {

    //     const catServicePage = new CAT_SERVICES;
    //     //Cypress.config('responseTimeout',112000);
    //     //Cypress.config('requestTimeout',112000);
    ...
    it("Smoke: Zlecenia", () => {
        ...
        navigationPage.sideMenuChildEQ('Etykiety', 1);
    ...
    it.skip("Smoke: Zarządzanie użytkownikami", () => {
        ...
        // navigationPage.sideMenuChild('Role');
    ...
    it("Smoke: Dokumenty", () => {
        ...
        navigationPage.sideMenuChildEQ('Szablony','0');
